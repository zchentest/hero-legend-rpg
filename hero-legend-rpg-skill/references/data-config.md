...
```javascript
const SKILLS = [
    // 格式: { bossIndex, name, emoji, desc, cooldown, [multiplier|hits|healPercent|...] }
    // bossIndex 对应 BOSSES 数组索引，击败对应BOSS后解锁技能
...
**技能平衡建议**：
- 以20回合为基准周期计算伤害效率
- 低倍率技能：1.5x~2x，冷却4-5回合
- 中倍率技能：3.5x~5x，冷却8-10回合
- 高倍率技能：7x~10x，冷却12-14回合
- 确保高倍率技能在相同周期内总伤害更高
